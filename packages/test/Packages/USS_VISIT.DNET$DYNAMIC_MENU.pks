...
CREATE OR REPLACE PACKAGE USS_VISIT.DNET$DYNAMIC_MENU
IS
    -- Author  : VANO
...
GRANT EXECUTE ON USS_VISIT.DNET$DYNAMIC_MENU TO DNET_PROXY
/

GRANT EXECUTE ON USS_VISIT.DNET$DYNAMIC_MENU TO II01RC_USS_VISIT_WEB
/


/* Formatted on 8/12/2025 6:00:01 PM (QP5 v5.417) */
CREATE OR REPLACE PACKAGE BODY USS_VISIT.DNET$DYNAMIC_MENU
IS
    PROCEDURE get_menu (p_menu OUT SYS_REFCURSOR)
    IS
    BEGIN
