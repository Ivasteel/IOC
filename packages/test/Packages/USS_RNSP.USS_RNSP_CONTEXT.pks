...
CREATE OR REPLACE PACKAGE USS_RNSP.USS_RNSP_CONTEXT
IS
    -- Author  : VANO
    -- Created : 10.06.2021 12:04:21
    -- Purpose : Контекстний пакет для Реєстру надавачів соціальних послуг

    gContext      CONSTANT VARCHAR2 (12) := 'USS_RNSP';
    gUID          CONSTANT VARCHAR2 (10) := 'USSUID';
    gUserTP       CONSTANT VARCHAR2 (10) := 'IUTP';
    gUserTPCode   CONSTANT VARCHAR2 (10) := 'IUTPCODE';
    gORG          CONSTANT VARCHAR2 (10) := 'ORG_ID';
